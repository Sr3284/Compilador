...
enum simbAceitos {BOLEAN, ELSE, FALSE, FUNCTIONS, GOTO, IF, INTEGER, LABELS, READ, RETURN, TRUE, TYPES,
...
OP_MINUS, OP_MINUSMINUS, OP_MULT, OP_DIV, OP_NOT, ID, NUM, COMENT, FIM, ERR};
